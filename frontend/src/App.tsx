...
function App() {
  ...
  const deleteFolder = async (folderName: string) => {
    if (
      !confirm(`Are you sure you want to delete the folder "${folderName}" and all its contents?`)
    )
      return;
        ...
        <div className="app">
          <div className="app-container">
            ...
            <div className="folder-management">
              <p>Files uploaded here will go to the same folder until you change the name.</p>
              ...
              <div>
                ...
                />
                <button onClick={searchFiles} disabled={loadingA}>
                  Search
                </button>
                  ...
                  {folders.map((folder) => (
                    ...
                    >
                      <div className="folder-header">
                        <h3
                          onClick={() => fetchFilesInFolder(folder)}
              ...
              {!searchResults.length && selectedFolder && (
                <div className="files-list">
                  <h2>
                    Files in "{selectedFolder}" ({files.length})
                  </h2>
